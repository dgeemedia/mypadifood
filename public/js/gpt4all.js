...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function show() { panel.classList.remove('hidden'); panel.setAttribute('aria-hidden','false'); input.focus(); }
  function hide() { panel.classList.add('hidden'); panel.setAttribute('aria-hidden','true'); }
